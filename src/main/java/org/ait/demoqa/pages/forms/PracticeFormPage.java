...
public class PracticeFormPage extends BasePage {
    ...
    public PracticeFormPage selectState(String st) {
        clickWithJSExecutor(state, 0, 200);
    ...
    public PracticeFormPage submit() {
       ...
       clickWithRectangle(submit, 8, 8);// не работает середина кнопки , нажимаем на верхнюю часть кнопки
        return this;
    }
    ...
    public PracticeFormPage selectDate(String month, String year, String day) {
        ...
        driver.findElement(By.xpath(
                "//div[@class='react-datepicker__week']//div[.='" + day + "']")).click();
    return this;
    }
